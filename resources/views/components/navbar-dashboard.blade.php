            ...
            <div class="flex items-center ml-3">
              <div>
                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                  ...
                  <span class="flex h-8 w-8 items-center justify-center rounded-full bg-primary-700 font-semibold text-white">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</span>
                </button>
              </div>
              <!-- Dropdown menu -->
                ...
                <ul class="py-1" role="none">
                  ...
                  <li>
                    <form method="POST" action="{{ route('logout') }}">
                      @csrf
                      <button type="submit" class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Keluar</button>
                    </form>
                  </li>
                </ul>
              </div>
